...
def player_analysis(movelist,pgn_evals):

    tag_labels = ['Event', 'Site', 'Date', 'White', 'Black', 'Result', 'UTCDate', 'UTCTime', 'WhiteElo', 'BlackElo', 'WhiteRatingDiff', 'BlackRatingDiff', 'Variant', 'TimeControl', 'ECO', 'Termination']
    ...
    for n in range(0, len(Eval_df)):
        ...
        working_evals_flt = pd.to_numeric(working_evals[:], errors='coerce', downcast='float')  # convert strings to float
